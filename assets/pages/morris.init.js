...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createLineChart('morris-line-example', $data, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#6D48E5', '#02c58d']);
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#6D48E5', '#02c58d']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#6D48E5', '#02c58d']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#fcbe2d', '#6D48E5', '#02c58d']);
        ...
        this.createLineChart1('morris-line-example-dark', $data1, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#6D48E5', '#02c58d']);
    },
    //init
